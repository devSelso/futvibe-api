...
public static class DataSeeder
{
    public static async Task SeedAsync(FutvibeDbContext db)
    {
        ...
        var u1 = User.Create("Rafael Costa",  "teste@futvibe.app",   hash, MatchLevel.Advanced,      "Rio de Janeiro/RJ");
        var u2 = User.Create("Juliana Melo",  "juliana@futvibe.app", hash, MatchLevel.Intermediate,   "Rio de Janeiro/RJ");
        var u3 = User.Create("Bruno Alves",   "bruno@futvibe.app",   hash, MatchLevel.Beginner,       "São Paulo/SP");
        var u4 = User.Create("Camila Torres", "camila@futvibe.app",  hash, MatchLevel.Advanced,       "Rio de Janeiro/RJ");
        var u5 = User.Create("Diego Nunes",   "diego@futvibe.app",   hash, MatchLevel.Intermediate,   "Florianópolis/SC");

        u1.UpdateProfile(u1.Name, "Jogando futevôlei há 8 anos. Apaixonado pelo esporte.", u1.Level, u1.City);
        u2.UpdateProfile(u2.Name, "Competidora nos fins de semana. Sempre em busca de bons parceiros.", u2.Level, u2.City);
        u3.UpdateProfile(u3.Name, "Novo no esporte, mas com muita vontade de aprender.", u3.Level, u3.City);
        u4.UpdateProfile(u4.Name, "Ex-vôlei de praia. Migrei para o futevôlei e não me arrependo.", u4.Level, u4.City);
        u5.UpdateProfile(u5.Name, "Jogo toda semana na Barra. Bora marcar!", u5.Level, u5.City);
        ...
        var matches = new[]
        {
            CreateMatch("Pelada da Barra — Sábado",
                "Praia da Barra, Posto 9", "Rio de Janeiro/RJ",
            ...
            CreateMatch("Treino Avançado Ipanema",
                "Praia de Ipanema, Posto 8", "Rio de Janeiro/RJ",
            ...
            CreateMatch("Futevôlei Iniciantes — Domingo",
                "Praia de Copacabana, Posto 6", "Rio de Janeiro/RJ",
            ...
            CreateMatch("Jogo Privado — Grupo Seleto",
                "Arena Beach, Barra da Tijuca", "Rio de Janeiro/RJ",
            ...
            CreateMatch("Pelada do Meio de Semana",
                "Praia do Leblon, Posto 12", "Rio de Janeiro/RJ",
    ...
    {
        var match = Match.Create(title, location, city, date, time, level, price, maxPlayers, visibility, hostId);
